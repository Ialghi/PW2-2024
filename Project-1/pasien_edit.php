    ...
    <div class="container-fluid px-4">
        ...
        <form action="pasien_update.php" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <textarea id="alamat" name="alamat" cols="40" rows="3" class="form-control"
                        required="required"><?= $pasien['alamat'] ?></textarea>
                </div>
            </div>
            <div class="form-group row">
