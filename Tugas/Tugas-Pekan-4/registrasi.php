        ...
        <div class="content-wrapper bg-dark" data-auto-dark-mode="true" data-loading-screen="750">
        <ul class="navbar-nav">
      </ul>
          <main>
            <div class="container-fluid">
              <h1>Registrasi</h1>
              <fieldset class="my-1 border p-2">
                <legend>Form registrasi IT Club</legend>
                <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css">
                <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">

                <form action="prosses-registrasi.php" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-8">
                      <input id="nl" name="nl" type="text" class="form-control" required="required">
                    </div>
                  </div>
                  <div class="form-group row">
